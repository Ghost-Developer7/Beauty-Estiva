...
const copy = {
    en: {
        ...
        placeholder: "Search",
        table: {
            cols: ["Customer", "Created", "Score", "Services", "Service date", "Customer review", "Your reply"],
            empty: "Total record count: 0"
        }
    },
    tr: {
        title: "Yorumlar",
        placeholder: "Ara",
        table: {
            cols: ["Müşteri", "Oluşturulma", "Puan", "Hizmetler", "Hizmet tarihi", "Müşteri yorumu", "Yanıtınız"],
            empty: "Toplam kayıt sayısı: 0"
        }
    },
};
