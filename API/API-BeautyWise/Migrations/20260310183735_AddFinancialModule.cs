        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppointmentPayments_Currencies_CurrencyId",
                        column: x => x.CurrencyId,
                        principalTable: "Currencies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppointmentPayments_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Currencies",
                columns: new[] { "Id", "Code", "DisplayOrder", "IsActive", "IsDefault", "Name", "Symbol" },
                values: new object[,]
                {
                    { 1, "TRY", 1, true, true, "Türk Lirası", "₺" },
                    { 2, "USD", 2, true, false, "ABD Doları", "$" },
                    { 3, "EUR", 3, true, false, "Euro", "€" },
                    { 4, "GBP", 4, true, false, "İngiliz Sterlini", "£" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentPayments_CurrencyId",
                table: "AppointmentPayments",
                column: "CurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentPayments_TenantId",
                table: "AppointmentPayments",
                column: "TenantId");
